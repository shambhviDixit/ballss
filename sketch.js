...
function setup() {
  ...
  ground = new Base(0, height - 10, width * 2, 20, "lightpink", true);
  leftWall = new Base(20, height / 2 + 50, 600, 100, "lightblue", true);
  rightWall = new Base(width - 300, height / 2 + 50, 600, 100, "lightblue", true);

  /*bridge = new Base(15, { x: width / 2 - 400, y: height / 2 });
  jointPoint = new Base(width - 600, height / 2 + 10, 40, 20, "#8d6e63", true);*/

  bridge = new Bridge(18, { x: width / 2 - 500, y: height / 2 });
